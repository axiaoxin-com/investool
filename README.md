...
```
./x-stock_darwin_amd64 -run checker -l error -k 医学

+--------------------+--------------------------------+
|    FAILED ITEM     |         FAILED REASON          |
+--------------------+--------------------------------+
| ROE VALUE          | Latest ROE:1.03 is not greater |
|                    | than:8                         |
+--------------------+--------------------------------+
| ROE INCREASING     | ROE is not increasing in 3     |
|                    | years. fina:[-7.48 46.2 5.55]  |
+--------------------+--------------------------------+
| EPS INCREASING     | EPS is not increasing in 3     |
|                    | years. fina:[-0.21 1.11 0.1]   |
+--------------------+--------------------------------+
| REVENUE INCREASING | REVENUE is not increasing in 3 |
|                    | years. fina:[9.9095268125e+08  |
|                    | 2.03934579366e+09              |
|                    | 4.05962800259e+09]             |
+--------------------+--------------------------------+
| PROFIT INCREASING  | PROFIT is not increasing in 3  |
|                    | years. fina:[-4.0393009511e+08 |
|                    | 2.18429448972e+09              |
|                    | 1.9453534683e+08]              |
+--------------------+--------------------------------+
| VALUATION STATUS   | Valuation status is high       |
+--------------------+--------------------------------+
| 国际医学 000516 SZ |             FAILED             |
+--------------------+--------------------------------+
```
